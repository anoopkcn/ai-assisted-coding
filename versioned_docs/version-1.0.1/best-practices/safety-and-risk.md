...
<p><small>
Sources: 
<a href="https://docs.anthropic.com/en/docs/test-and-evaluate/strengthen-guardrails/mitigate-jailbreaks">Anthropic: Mitigate jailbreaks and prompt injections</a>,
<a href="https://platform.openai.com/docs/guides/agent-builder-safety">OpenAI: Safety in building agents</a>,
<a href="https://docs.github.com/en/code-security/secret-scanning/introduction/about-secret-scanning">GitHub secret scanning</a>
</small></p>
