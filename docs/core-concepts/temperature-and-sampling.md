...
<p><small>Sources: <a href="https://platform.openai.com/docs/guides/text#temperature-and-top_p">OpenAI temperature/top_p guidance</a>, <a href="https://docs.anthropic.com/en/api/messages#body-temperature">Anthropic Messages API temperature parameter</a></small></p>
